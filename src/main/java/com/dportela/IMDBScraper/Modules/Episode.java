...
public class Episode {
    ...
    public void scrapData(Element episode_soup) throws ErrorProcessingEpisodeException {
        ...
        try {
            ...
            throw new ErrorProcessingEpisodeException("Error processing episode " + number + ". " + e.getMessage());
        }
